...
<h5>Algunos de ellos están instalados en Luxemburgo</h5>

<?php $year=0;?>
<ol>
<?php for($n = 0; $n < $todos; $n++){?>
  <?php if(($datos[$n]['country_code']) == 'LU'){?>
...
<h5><?php echo $year;?> de los instalados en Luxemburgo han generado indicadores durante este año</h5>
